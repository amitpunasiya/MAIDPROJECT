...
export const MOCK_CATEGORIES_DATA: ICategoryCard[] = [
  ...
  },
  {
    id: 'physiotherapist',
    title: 'Physiotherapy',
    subtitle: 'Licensed Home Visit Physiotherapist',
    description: 'Certified physiotherapists for home visits: post-operative rehab, orthopedic recovery, sports injury, neurological care, and geriatric pain management.',
    icon: <ElderlyIcon sx={{ fontSize: 32, color: '#0284C7' }} />,
    image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=600&q=80',
    startingPrice: '₹800 / visit',
    activeStaffCount: 290,
    popularServices: ['Post-Op Rehab', 'Orthopedic Care', 'Home Visit Therapy', 'Sports & Neuro Rehab'],
    routeCategory: 'physiotherapist',
  },
  {
    id: 'occupational_therapist',
    title: 'Occupational Therapy',
    subtitle: 'Specialized Functional & Pediatric OT',
    description: 'Expert occupational therapists for home visits: pediatric therapy, fine motor skills, sensory integration, activities of daily living (ADL) training & cognitive rehab.',
    icon: <ElderlyIcon sx={{ fontSize: 32, color: '#0D9488' }} />,
    image: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=600&q=80',
    startingPrice: '₹850 / visit',
    activeStaffCount: 210,
    popularServices: ['Pediatric OT', 'ADL Training', 'Fine Motor Skills', 'Sensory & Cognitive Rehab'],
    routeCategory: 'occupational_therapist',
  },
  {
    id: 'home_helper',
